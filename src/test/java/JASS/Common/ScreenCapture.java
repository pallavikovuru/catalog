...
public class ScreenCapture {
	...
	private static final String SCREENSHOT_FOLDER_TIMESTAMP = new SimpleDateFormat("MM-dd-yyyy_hh.mm.ss")
			.format(new Date());
	...
	public String takeScreenShoot() throws Exception {
		String browser = ReadPropertyFile.getConfigPropertyVal("BrowserType");
		File screenshot;
		screenshot = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
		String nameScreenshot = String.valueOf(System.currentTimeMillis());
		logger.info("Screen Name:=" + nameScreenshot);
		String path = getPath(nameScreenshot);
		...
		serverPath = serverPath.substring(13); 
	...
	private String getPath(String nameTest) throws IOException {
		...
		String newFileNamePath = directory.getCanonicalPath() + "/screenshots/" + SCREENSHOT_FOLDER_TIMESTAMP + "/"
